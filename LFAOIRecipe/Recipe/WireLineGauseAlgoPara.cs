...
{
    public class WireLineGauseAlgoPara : ViewModelBase, IParameter
    {
        private int index;
        public int Index
        {
        ...
        private string name = "line_guass_sort";
        public string Name
        {
            get => name;
        ...
        public WireLineGauseAlgoPara(int index)
        {
            this.index = index;
        }
        //add by lht
        public WireLineGauseAlgoPara()
        {
            Index = 0;
        }
        ...
        //add lht
        public static WireLineGauseAlgoPara DeepCopyByReflection<WireLineGauseAlgoPara>(WireLineGauseAlgoPara obj)
        {
            ...
            foreach (var field in fields)
            {
                ...
                {
                    MessageBox.Show("区域-金线高效率参数-赋值出现错误");
                    return (WireLineGauseAlgoPara)retval;
                }
            }
