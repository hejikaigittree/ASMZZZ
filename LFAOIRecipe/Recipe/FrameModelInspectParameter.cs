...
{
    class FrameModelInspectParameter : ViewModelBase, IParameter
    {
        private int imageFrameVerifyChannelIndex = 0;
        public int ImageFrameVerifyChannelIndex
        {
            get => imageFrameVerifyChannelIndex;
            set => OnPropertyChanged(ref imageFrameVerifyChannelIndex, value);
        }
        ...
        private bool isFrameSurfaceInspect = true;
        /// <summary>
        /// 是否框架表面检测
        /// </summary>
        public bool IsFrameSurfaceInspect
        {
            get => isFrameSurfaceInspect;
            set => OnPropertyChanged(ref isFrameSurfaceInspect, value);
        }
    }
}
