...
{
    class PegRackModelInspectParameter : ViewModelBase, IParameter
    {
        private bool isPegRackSurfaceInspect = true;
        /// <summary>
        /// 是否钉架表面检测
        /// </summary>
        public bool IsPegRackSurfaceInspect
        {
            get => isPegRackSurfaceInspect;
            set => OnPropertyChanged(ref isPegRackSurfaceInspect, value);
        }

        private int imagePegRackVerifyChannelIndex = 0;
        public int ImagePegRackVerifyChannelIndex
        {
            get => imagePegRackVerifyChannelIndex;
            set => OnPropertyChanged(ref imagePegRackVerifyChannelIndex, value);
        }
