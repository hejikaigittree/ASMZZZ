...
namespace JFMethodCommonLib.自定义
{
    ...
    class JFCM_ExpMyDataType_D : JFMethodInitParamBase, IJFMethodFlowAcq
    {
        ...
        protected override bool ActionGenuine(out string errorInfo)
        {
           ...
           // LoadParam LoadSta = (LoadParam)ob;
            if(!ob.GetType().IsAssignableFrom(typeof(LoadParam)))
            {
            ...
            foreach(System.Reflection.PropertyInfo info in ob.GetType().GetProperties())
            {
               ...
               DescriptionAttribute myAttribute = (DescriptionAttribute)attributes[typeof(DescriptionAttribute)];
                ...
                {
                   _jf.DataPool.Add(name, info.GetValue(ob));
                   _jf.TypePool.Add(name, info.GetType());
                }                           
            }
            errorInfo = "Success";
            return true;
