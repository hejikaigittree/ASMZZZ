...
{
    /// <summary>
    /// JFCM_GetDI_D 获取一个DI通道的状态
    /// </summary>
    [JFCategoryLevels(new string[] { "JF 设备控制", "DIO" })]
    [JFDisplayName("获取DI状态_D")]
    public class JFCM_GetDI_D : JFMethodInitParamBase
    {
        public JFCM_GetDI_D()
        {
            string[] allDiNames = JFHubCenter.Instance.MDCellNameMgr.AllDiNames();
            DeclearInput("DI通道名称", typeof(string), "");
        ...
        {
            //string diName = GetMethodInputValue("DI通道名称") as string;
