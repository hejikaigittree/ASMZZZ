...
namespace JFMethodCommonLib.轴控制
{
    ...
    [JFDisplayName("等待轴直线插补完成_S")]

    public class JFCM_WaitLineMove_S : JFMethodInitParamBase, IJFMethod_T
    {
        //Init Param's Name 
        ...
        protected override bool ActionGenuine(out string errorInfo)
        {
            ...
            for (int i = 0; i < axisIDList.Length; i++)
            {
                ...
                JFDevChannel axisChn = new JFDevChannel(JFDevCellType.Axis, axisIDList[i]);
            ...
            bool isAbs = (bool)GetInitParamValue(PN_AbsMode);
        ...
        int _workCmd = 0; //-1：指令退出 0:正常运行，1:暂停 ，2：恢复
