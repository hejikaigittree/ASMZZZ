...
using System.Linq;
using JFToolKits.Collections.ObjectModel;
...
namespace JFToolKits.Collections
{
	...
	/// 请参见我的博文<see href="http://www.cnblogs.com/JFToolKit/archive/p/BitList.html">
	/// 《C# 位压缩列表》</see>。</para>
	/// <para>由于位操作的复杂性，<see cref="BitList"/> 类的一些方法效率并不高，
	/// 实际使用时需要做好相应的测试。</para>
	/// </remarks>
	/// <seealso href="http://www.cnblogs.com/JFToolKit/archive/p/BitList.html">
	/// 《C# 位压缩列表》</seealso>
	[Serializable]
