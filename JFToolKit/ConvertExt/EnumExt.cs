...
namespace JFToolKits
{
	...
	/// 获取与解析，可以参考我的博文 
	/// <see href="http://www.cnblogs.com/JFToolKit/archive/p/EnumDescription.html">
	/// C# 获取与解析枚举类型的 DescriptionAttribute</see></para>
	/// <para>内部使用 <see cref="JFToolKits.Utility.ICache{TKey,TValue}"/> 
	/// 接口缓存枚举的描述，使用的键为 JFToolKits.EnumDescriptionCache。
	/// 关于如何设置缓存，可以参见 <see cref="CacheFactory"/>。</para>
	/// </remarks>
	/// <seealso href="http://www.cnblogs.com/JFToolKit/archive/p/EnumDescription.html">
	...
	public static class EnumExt
	{
		...
		private static readonly ICache<Type, EnumCache> EnumCaches =
			CacheFactory.CreateCache<Type, EnumCache>("JFToolKits.EnumDescriptionCache") ??
