...
namespace JFToolKits.IO
{
	...
	/// <see href="http://www.cnblogs.com/JFToolKit/archive/p/LexerInputBuffer.html#SourceLocation">
	/// 《C# 词法分析器（二）输入缓冲和代码定位》</see>。</remarks>
	/// <seealso href="http://www.cnblogs.com/JFToolKit/archive/p/LexerInputBuffer.html#SourceLocation">
