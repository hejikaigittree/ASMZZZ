...
namespace JFMethodCommonLib
{
    ...
    [JFDisplayName("打开通道(替身名)所属设备_S")]
    [JFVersion("1.0.0.0")]
    public class JFSM_OpenChnDevAlias_S : JFMethodInitParamBase, IJFStationBaseAcq
    {
        static string PN_DevChnName = "设备通道替身名称";
        static string PN_DevChnType = "设备通道类型";
        public JFSM_OpenChnDevAlias_S()
        {
        ...
        protected override bool ActionGenuine(out string errorInfo)
        {
            ...
            NamedChnType chnType = (NamedChnType)GetInitParamValue(PN_DevChnType);
            string devChnName = GetInitParamValue(PN_DevChnName) as string;
            return _station.OpenChnDeviceAlias(chnType, devChnName, out errorInfo);
