...
namespace JFToolKits
{
	...
	/// <see href="http://www.cnblogs.com/JFToolKit/archive/p/DelegateBuilder.html">
	/// 《C# 反射的委托创建器》</see>。</para>
	/// </remarks>
	/// <seealso href="http://www.cnblogs.com/JFToolKit/archive/p/DelegateBuilder.html">《C# 反射的委托创建器》</seealso>
