...
{
    /// <summary>
    /// JFCM_WaitDO_D 等待一个DO通道的状态
    /// </summary>
    [JFCategoryLevels(new string[] { "JF 设备控制", "DIO" })]
    [JFDisplayName("等待DO状态_D")]

    public class JFCM_WaitDO_D : JFMethodInitParamBase, IJFMethod_T
    {
        //Init Param's Name 
        ...
        public JFCM_WaitDO_D()
        {
            ...
            DeclearInput(PN_WaitDOStatus, typeof(bool), true);
        ...
        {
            _isRunning = true;
            string doName = GetMethodInputValue(PN_DOID) as string;
            ...
            bool isDOEnable = (bool)GetMethodInputValue(PN_WaitDOStatus);
