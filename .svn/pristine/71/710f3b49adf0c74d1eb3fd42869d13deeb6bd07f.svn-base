...
namespace JFToolKits
{
	...
	/// 可以参见我的博文
	/// <see href="http://www.cnblogs.com/JFToolKit/archive/p/PowerBinder.html">
	/// 《C# 使用 Binder 类自定义反射》</see>。</para>
	/// <para>关于进行泛型类型推断的原理，可以参考我的博文
	/// <see href="http://www.cnblogs.com/JFToolKit/archive/p/GenericArgumentsInferences.html">
	/// 《C# 泛型方法的类型推断》</see>。</para>
	/// </remarks>
	/// <seealso href="http://www.cnblogs.com/JFToolKit/archive/p/PowerBinder.html">
	/// 《C# 使用 Binder 类自定义反射》</seealso>
	/// <seealso href="http://www.cnblogs.com/JFToolKit/archive/p/GenericArgumentsInferences.html">
	/// 《C# 泛型方法的类型推断》</seealso>
	[Serializable]
	public sealed class PowerBinder : Binder
	{
		/// <summary>
		/// 默认的 <see cref="JFToolKits.PowerBinder"/> 实例。
		/// </summary>
		private static PowerBinder defaultInstance;
		/// <summary>
		/// 允许强制类型转换的 <see cref="JFToolKits.PowerBinder"/> 实例。
		/// </summary>
		private static PowerBinder castInstance;
		/// <summary>
		/// 获取默认的 <see cref="JFToolKits.PowerBinder"/> 实例。
		/// </summary>
		/// <value>默认的 <see cref="JFToolKits.PowerBinder"/> 实例，只对泛型方法提供支持。</value>
		...
		/// <summary>
		/// 获取允许强制类型转换的 <see cref="JFToolKits.PowerBinder"/> 实例。
		/// </summary>
		/// <value>允许强制类型转换的 <see cref="JFToolKits.PowerBinder"/> 实例，
		...
		/// <summary>
		/// 初始化 <see cref="JFToolKits.PowerBinder"/> 类的新实例。
		/// </summary>
		...
		private static bool MakeGenericMethod(MatchInfo match, Type[] types)
		{
			...
			Type[] args = JFTypeExt.GenericArgumentsInferences(method.GetGenericArguments(),
