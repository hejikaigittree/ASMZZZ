...
namespace JFToolKits.Utility
{
	...
	/// <code>
	/// <configSections>
	///		<!-- 这里的 Section 名称必须为 JFToolKits.cache -->
	///		<section name="JFToolKits.cache" type="JFToolKits.Utility.CacheSection, JFToolKit"/>
	/// </configSections>
	/// <JFToolKits.cache>
	///		<!-- key 是缓冲池的键，cacheType 是缓冲池的类型，option 是缓冲池构造函数参数的名称和相应的值。 -->
	///		<cache key="JFToolKits.EnumDescriptionCache" cacheType="JFToolKits.Utility.LruCacheNoSync`2, JFToolKit" >
	...
	public static class CacheFactory
	{
		...
		/// 缓冲池配置节的名称。
		/// </summary>
		public const string SectionName = "JFToolKits.cache";
		/// <summary>
		/// 当创建缓冲池出现异常时发生。
		/// </summary>
